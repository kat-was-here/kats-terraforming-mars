    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          b.action('Spend 9 M€ to place 1 ocean tile. STEEL MAY BE USED as if you were playing a building card.',
            (eb) => eb.megacredits(9).super((b) => b.steel(1)).startAction.oceans(1));
        }),
      },
    });
  }
